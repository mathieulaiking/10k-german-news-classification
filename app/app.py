...
pipe = pipeline("text-classification", tokenizer=tokenizer, model=model, return_all_scores=True)
...
examples = [
    "Erfundene Bilder zu Filmen, die als verloren gelten: The Forbidden Room von Guy Maddin und Evan Johnson ist ein surrealer Ritt durch die magischen Labyrinthe des frÃ¼hen Kinos. Wien â€“ Die Filmgeschichte ist ein Friedhof der Verlorenen. Unter den Begrabenen finden sich zahllose Filme, von denen nur noch mysteriÃ¶s oder abenteuerlich klingende Namen kursieren",
    "21-JÃ¤hriger fÃ¤llt wohl bis Saisonende aus. Wien â€“ Rapid muss wohl bis Saisonende auf Offensivspieler Thomas Murg verzichten. Der im Winter aus Ried gekommene 21-JÃ¤hrige erlitt beim 0:4-Heimdebakel",
]
